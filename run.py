...
import random
import numpy as np
from layers.utils import set_conv_type
...
def main():
    ...
    parser.add_argument('--tags', type=str, nargs="*", default=[], help='extra tags for wandb')
    ...
    parser.add_argument('--root_path', type=str, default='/data/hanlu/ts-data/', help='root path of the data file')
    ...
    # model define
    parser.add_argument('--conv_type', type=str, default='normal', help='share convolution weight')
    ...
    parser.add_argument('--channel_independent', action='store_true',
                        help='weather train with global dataset',
                        default=False)
    ...
    parser.add_argument('--train_loss', type=str, default='mse', help='training loss function')
    parser.add_argument('--huber_beta', type=float, default=1.0, help='loss function')
    ...
    set_conv_type(args)
    if args.model == "gbrt":
        from exp.exp_GBRT import Exp_GBRT
        Exp = Exp_GBRT
    else:
